...
## [0.20.1](https://github.com/praxiomlabs/rust-mssql-driver/compare/v0.20.0...v0.20.1) - 2026-07-02
...
- *(encryption)* normalize AE temporal to .NET's fixed-width form; pad char/nchar on read
...
- *(types)* reject numeric() values exceeding the declared precision

### Other

- *(client)* assert behaviour in three connection-string edge cases
- clarify Always Encrypted decimal binding; refresh stale markers
...
- *(client)* split LOGIN7 at the 4096-byte TDS default for large FEDAUTH tokens

### Other

- *(client)* live managed-identity FEDAUTH login test ([#155](https://github.com/praxiomlabs/rust-mssql-driver/pull/155))
...
- correct stale capability claims in crate READMEs and state docs
